...
local function get_codelldb()
  ...
  local extension_path = (require("mason-core.installer.InstallLocation").global():package "codelldb") .. "/extension/"
...
return {
  ...
  },
  {
    ...
    dependencies = { "rust-lang/rust.vim" }, -- { "simrat39/rust-tools.nvim", "rust-lang/rust.vim" },
    opts = {
      servers = {
        rust_analyzer = {
          settings = {
