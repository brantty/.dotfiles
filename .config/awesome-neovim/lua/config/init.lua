...
vim.lsp.handlers["textDocument/hover"] = vim.lsp.buf.hover({ border = diagnostics_options.float.border })
--
vim.lsp.handlers["textDocument/signatureHelp"] = vim.lsp.buf.signature_help({ border = diagnostics_options.float.border })
