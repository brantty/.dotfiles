return {
    ...
    -- completion engine
    {
        ...
        dependencies = {
            ...
            -- Completion Sources --
            -- nvim-cmp source for neovim builtin LSP ciient
            { "hrsh7th/cmp-nvim-lsp", lazy = true },
            -- nvim-cmp source for path
            { "hrsh7th/cmp-path", lazy = true },
            -- nvim-cmp source for buffer words
            { "hrsh7th/cmp-buffer", lazy = true },
            -- nvim-cmp source for lua
            ...
            return {
                ...
                formatting = {
                    format = function(entry, vim_item)
                        ...
                        -- Kind icons
                        -- This concatonates the icons with the name of the item
                        -- kind
        ...
        config = function(_, opts)
            ...
            -- Use path & cmdline source for `:` (if you enabled `native_menu`,
            -- this won't work anymore).
            cmp.setup.cmdline(":", {
                mapping = cmp.mapping.preset.cmdline(),
                sources = {
