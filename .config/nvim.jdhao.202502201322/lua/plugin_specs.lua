...
local plugin_specs = {
  ...
  },
  {
    ...
    branch = "main",
    keys = {
      utils.lazy_map("]1", "ToggleTermSpotify", { "n", "t" }),
      utils.lazy_map("]2", "ToggleTermDocker", { "n", "t" }),
      utils.lazy_map("]3", "ToggleTermLazyGit", { "n", "t" }),
      utils.lazy_map("]4", "ToggleTermFish", { "n", "t" }),
      utils.lazy_map("]5", "ToggleTermWeeChat", { "n", "t" }),
      utils.lazy_map("]8", "ToggleTermRepl", { "n", "t" }),
      utils.lazy_map("]0", "ToggleTermPowershell", { "n", "t" }),
    },
    config = function()
