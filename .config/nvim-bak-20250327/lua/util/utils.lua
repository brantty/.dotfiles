...
--- Generate random integers in the range [Low, High], inclusive, adapted from
--- https://stackoverflow.com/a/12739441/6064933
--- @param low integer the lower value for this range
--- @param high integer the upper value for this range
function M.rand_init(low, high)
	-- Use lua to generate random int, see also:
	-- https://stackoverflow.com/20157671/6064933
