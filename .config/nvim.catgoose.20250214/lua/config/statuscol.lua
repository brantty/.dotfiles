...
M.ffi.cdef([[
  ...
  typedef struct {
    int start;  // line nubmer where deepest fold starts
...
function M.get_signs()
  local buf = vim.api.nvim_win_get_buf(vim.g.statusline_windid)
...
function M.fold_col()
  ...
  local wp = M.ffi.C.find_window_by_handle(vim.g.statusline_wind, M.ffi.new("Error"))
...
function M.sign_col()
  ...
  return {
    ...
    git_sign = git_sign and ("%#" .. git_sign.texthl .. "#" .. git_sign.text .. "%*")
  }
end
